                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-7xl">
                    ...
                    <div className="flex items-center text-black lg:order-2">
                        ...
                        {status ?
                            ...
                            className="text-neutral-700 bg-orange-700 hover:bg-orange-800 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none"
                            >
                                Lagout
                            </Link>
                        :
                    ...
                    <div className="hidden justify-between text-black items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
